    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200/50 bg-gradient-to-br from-white/80 via-white/60 to-slate-50/80 shadow-xl shadow-slate-200/50 backdrop-blur-xl dark:border-slate-700/50 dark:from-slate-800/80 dark:via-slate-800/60 dark:to-slate-900/80 dark:shadow-slate-900/50">
      ...
      <div className="p-6">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <Input
                ...
                aria-label="Enter your AniList username"
          ...
          >
            This is your public AniList username. We don&apos;t need your
            password.
          </p>
          ...
          <p className="text-sm leading-relaxed text-slate-500 dark:text-slate-400">
            ...
            <a
              ...
              className="rounded font-medium text-blue-600 transition-colors hover:text-blue-700 hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 dark:text-blue-400 dark:hover:text-blue-300"
            >
              AniList <span className="sr-only">(opens in a new window)</span>
            </a>{" "}
          ...
          {/* Value Props */}
          <ul
            className="flex flex-wrap items-center gap-4 border-t border-slate-200/50 pt-5 dark:border-slate-700/50"
            aria-label="Benefits of using this generator"
          >
