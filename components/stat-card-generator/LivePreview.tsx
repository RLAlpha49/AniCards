...
import { LivePreviewSkeleton } from "@/components/stat-card-generator/LivePreviewSkeleton";
 ...
 * @property isLoading - Optional loading state to show skeleton during generation.
 * @source
 */
 ...
 * @param isLoading - Optional loading state to show skeleton during generation.
  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      <AnimatePresence mode="wait">
        {isLoading ? (
          <LivePreviewSkeleton key="skeleton" show={isLoading} />
        ) : (
          <motion.div
            key="content"
