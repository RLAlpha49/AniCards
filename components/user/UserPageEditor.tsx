...
import {
  ...
  LEAVE_EDITOR_CONFIRMATION_MESSAGE,
  parseVisibilityParam,
  type ReorderModeFilterSession,
...
} from "./editor/filter-navigation-helpers";
...
export function UserPageEditor({
  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div className="
        pointer-events-none absolute inset-0 user-editor-diamond-pattern opacity-30
        dark:opacity-20
      " />
