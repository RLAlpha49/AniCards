...
const LAYOUTS: Record<"hero" | "search", LayoutSlot[]> = {
  hero: [
    {
      id: "hero-slot-0",
      className: "absolute top-[15%] left-[5%] -rotate-6 hidden lg:block",
    ...
    {
      id: "hero-slot-1",
      className: "absolute top-[20%] right-[5%] rotate-6 hidden lg:block",
      baseAnimate: { y: 15, rotate: 6 },
      delay: 0.5,
      opacity: 0.92,
    },
    {
      id: "hero-slot-2",
      className: "absolute bottom-[20%] left-[10%] rotate-12 hidden lg:block",
    ...
    {
      id: "hero-slot-3",
      className: "absolute bottom-[25%] right-[10%] -rotate-12 hidden lg:block",
      baseAnimate: { y: 20, rotate: -12 },
      delay: 1.5,
      opacity: 0.92,
    },
    {
      id: "hero-slot-4",
      className: "absolute top-[45%] left-[-2%] -rotate-12 hidden xl:block",
    ...
    {
      id: "hero-slot-5",
      className: "absolute top-[50%] right-[-2%] rotate-12 hidden xl:block",
      baseAnimate: { y: 10, rotate: 12 },
      delay: 2.5,
      opacity: 0.75,
    },
